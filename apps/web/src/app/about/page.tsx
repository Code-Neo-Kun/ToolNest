    ...
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
      ...
      <div className="mb-14 text-center">
        ...
        <p className="mt-4 text-lg text-slate-600 dark:text-slate-400 max-w-xl mx-auto leading-relaxed">
          I got tired of online tools that are slow, covered in ads, and ask you
          to sign up just to format some JSON. So I built ToolNest — a
          collection of fast, clean, free tools that just work.
        </p>
      ...
      <section className="mb-14">
        ...
        <div className="space-y-4 text-slate-600 dark:text-slate-400 leading-relaxed">
          <p>
            As a developer, I use online tools every single day — image
            compressors, JSON formatters, Base64 encoders, password generators.
            The problem? Most of them are either covered in pop-up ads,
            painfully slow, or gate basic features behind a login.
          </p>
          <p>
            I wanted a single place where I could open a tool and use it
            immediately. No signup. No ads blocking the UI. No uploading files
            to some random server I don&apos;t trust. Just the tool, doing its
            job, fast.
          </p>
          <p>
            That&apos;s ToolNest. I build and maintain it in my spare time.
            Every tool is something I personally use or have needed at some
            point. If there&apos;s a tool you want that&apos;s missing, reach
            out — I genuinely read every message.
          </p>
        </div>
      </section>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 p-8 dark:from-amber-950/20 dark:to-orange-950/20 dark:border-amber-800/40">
          ...
          <div className="relative text-center">
            ...
            <p className="mt-3 text-slate-600 dark:text-slate-400 max-w-md mx-auto">
              ToolNest is free and always will be. If it saves you time and you
              want to say thanks, your support keeps the servers running and new
              tools coming.
            </p>
          ...
          <div className="relative mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-amber-200 bg-white/80 p-5 dark:bg-slate-800/60 dark:border-amber-700/40">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="ml-auto text-xs rounded-full bg-green-100 text-green-700 px-2 py-0.5 font-medium dark:bg-green-900/30 dark:text-green-400">
                  India
                </span>
              </div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div
                    key={upi.id}
                    className="flex items-center justify-between rounded-xl bg-slate-50 dark:bg-slate-900 px-3 py-2.5 gap-2"
                  >
                    <div>
          ...
          <p className="relative mt-5 text-center text-xs text-slate-400">
            Every rupee goes directly into hosting, domain, and building more
            tools 💛
          </p>
        </div>
      </section>
