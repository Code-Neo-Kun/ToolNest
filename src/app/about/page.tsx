...
// Branded SVG icons not included in lucide-react v1
const IconGithub = () => (
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
      ...
      <div className="mb-14 text-center">
        {/* Avatar placeholder */}
        <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 text-4xl shadow-lg">
          👨‍💻
        </div>
      ...
      {/* Support / Donate */}
      <section className="mb-14">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 p-8 text-center dark:from-amber-950/20 dark:to-orange-950/20 dark:border-amber-800/40">
          {/* Decorative blobs */}
          ...
          <div className="relative">
            ...
            <p className="mt-3 text-slate-600 dark:text-slate-400 max-w-md mx-auto">
              ...
              to say thanks, buying me a coffee keeps the servers running and new
              tools coming.
            </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-6 inline-flex items-center gap-2.5 rounded-2xl bg-amber-400 px-7 py-3.5 text-base font-bold text-white shadow-md hover:bg-amber-500 active:scale-[0.98] transition-all"
            >
              <Coffee className="h-5 w-5" />
              Buy me a coffee
            </a>

            {/* Supporter counts - social proof placeholder */}
            <p className="mt-4 text-xs text-slate-400">
              Join the people who keep ToolNest alive 💛
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-8 text-center dark:border-slate-700 dark:bg-slate-800">
        ...
        <p className="mt-2 text-slate-500 dark:text-slate-400 text-sm">
          I read everything. Reach out on Twitter or open an issue on GitHub.
        </p>
