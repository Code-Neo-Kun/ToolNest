    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-slate-900 dark:via-slate-900 dark:to-indigo-950/30 py-16 sm:py-24">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
          ...
          <p className="mt-4 text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Fast, free online tools for images, PDFs, text, developer utilities, SEO, and more.
      ...
      <section className="border-y border-slate-100 bg-slate-50 dark:border-slate-800 dark:bg-slate-900/50 py-4">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-6 sm:gap-10 text-sm text-slate-600 dark:text-slate-400">
            {[
              { icon: <Zap className="h-4 w-4 text-indigo-500" />, text: "Instant results" },
              { icon: <Shield className="h-4 w-4 text-emerald-500" />, text: "No file uploads to server" },
              { icon: <Globe className="h-4 w-4 text-blue-500" />, text: "Works in any browser" },
            ].map((f, i) => (
      ...
      <section className="py-8 bg-slate-50 dark:bg-slate-900/30">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/all-tools" className="flex items-center gap-1 text-sm font-medium text-indigo-600 hover:text-indigo-700 dark:text-indigo-400">
      ...
      {newTools.length > 0 && (
        <section className="py-12">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white">🆕 New Tools</h2>
            </div>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {newTools.map((tool) => (
                <ToolCard key={tool.slug} tool={tool} />
      ...
      <section className="py-16 bg-indigo-600 dark:bg-indigo-700">
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="text-3xl font-bold text-white">All tools are completely free</h2>
