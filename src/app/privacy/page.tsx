...
export const metadata: Metadata = {
  ...
  description: "ToolNest privacy policy. Learn how we handle your data — spoiler: we barely collect any.",
    ...
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
      <div className="mb-10">
        ...
        <div className="mt-4 rounded-xl bg-emerald-50 border border-emerald-200 px-5 py-4 text-sm text-emerald-800 dark:bg-emerald-950/20 dark:border-emerald-800/40 dark:text-emerald-300">
          <strong>Short version:</strong> Most tools run entirely in your browser.
          We don&apos;t store your files or personal data. We use analytics to understand
          traffic, and ads to keep the site free.
        </div>
      </div>
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none space-y-8 text-slate-600 dark:text-slate-400">
        ...
        <section>
          ...
          <p>
            {SITE_NAME} (<a href={SITE_URL} className="text-indigo-600 hover:underline">{SITE_URL}</a>) is
            an online tools platform built and operated by Uddhav Shrimali. If you have
        ...
        <section>
          ...
          <h3 className="text-base font-semibold text-slate-800 dark:text-slate-200 mb-2">Data we do NOT collect</h3>
          <ul className="list-disc pl-5 space-y-1">
            <li>Files you upload or process — all processing happens in your browser</li>
            <li>Account information — there are no accounts</li>
            <li>Passwords you generate — generated locally, never transmitted</li>
            <li>Text you type into tools — processed client-side only</li>
          </ul>

          <h3 className="text-base font-semibold text-slate-800 dark:text-slate-200 mt-4 mb-2">Data we do collect</h3>
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <strong>Analytics data</strong> — page views, session duration, referrer,
              browser type, and country via Google Analytics. This is anonymized and
              aggregated.
            </li>
            <li>
              <strong>Cookies</strong> — set by Google Analytics and Google AdSense for
              analytics and advertising purposes.
            </li>
            <li>
              <strong>IP address</strong> — collected by our hosting provider (Vercel)
              for security and performance. Not stored by us.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">We do not sell, rent, or share your data with third parties for their marketing purposes.</p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            {[
              { name: "Google Analytics", purpose: "Website traffic analytics", link: "https://policies.google.com/privacy" },
              { name: "Google AdSense", purpose: "Display advertising", link: "https://policies.google.com/privacy" },
              { name: "Vercel", purpose: "Website hosting and CDN", link: "https://vercel.com/legal/privacy-policy" },
              { name: "Buy Me a Coffee", purpose: "Voluntary donations", link: "https://www.buymeacoffee.com/privacy-policy" },
            ].map((s) => (
              <div key={s.name} className="flex gap-3 rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 dark:border-slate-700 dark:bg-slate-800">
                <div className="flex-1">
                  <span className="font-medium text-slate-800 dark:text-slate-200">{s.name}</span>
                  <span className="text-slate-500 dark:text-slate-400"> — {s.purpose}</span>
                </div>
                <a href={s.link} target="_blank" rel="noopener noreferrer" className="text-xs text-indigo-600 hover:underline shrink-0">
                  Privacy policy
                </a>
              </div>
            ))}
        ...
        <section>
          <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-3">6. Your rights (GDPR / CCPA)</h2>
        ...
        <section>
          ...
          <p>
            ToolNest is not directed at children under 13. We do not knowingly collect
        ...
        <section>
          ...
          <p>
            ...
            &quot;Last updated&quot; date at the top. Continued use of the site after
        ...
        <section>
          ...
          <p>
            ...
            <a href={`mailto:${CONTACT_EMAIL}`} className="text-indigo-600 hover:underline">{CONTACT_EMAIL}</a>{" "}
            or find us on{" "}
            <a href="https://twitter.com/yourusername" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">
              Twitter
            </a>.
          </p>
        </section>
